...
?>
	...
	<fieldset>
		...
		<?php
		#echo "SELECT * FROM maklumat_pelajar WHERE no_kp LIKE '%$search_val%' OR nama_pelajar LIKE '%$search_val%'";
	...
	<tr>
		...
		<td><a href="papar_kesalahan_pelajar.php?no_kp=<?php echo $info1['no_kp']; ?>">Papar</a></td>
	</tr>
		<?php
		$no++;
	}
